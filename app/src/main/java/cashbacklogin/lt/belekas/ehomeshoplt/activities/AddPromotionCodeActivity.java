...
public class AddPromotionCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("promoId") != null){
            ...
            loadPromoInfo(); // load promotion code into to set in our views, so we can also update single value
        ...
        // handle click, add promotion code to firebase
    ...
    private void datePickDialog() {
        ...
        // disable pas dates selection on calendar
